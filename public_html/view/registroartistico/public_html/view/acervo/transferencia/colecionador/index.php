...
<?php echo '<link rel="stylesheet" href="' . $config["assets"] . 'css/acervo-transferencia-colecionador-get.css?v=1">' ?>
                ...
                <div id="form_get">
                    <div class="card bg-light pb-4" style="border-radius: 25px;">
                        <div class="card-body">
                            <div id="form_top">
                                <div id="form_titulo">
                                    <h5 class="card-title">Pesquisa da Colecionador</h5>
                                </div>
                            </div>
                            <div class="form-row">
                                <!-- Nome -->
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="form_get_id" placeholder="Digite o ID da colecionador" required>
                                </div>
...
<?php echo '<script src="' . $config["assets"] . 'js/call/acervo-transferencia-colecionador-get.js?v=4"></script>' ?>