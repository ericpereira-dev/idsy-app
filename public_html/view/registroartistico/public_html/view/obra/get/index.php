...
<?php echo '<link rel="stylesheet" href="' . $config["assets"] . 'css/obra-get.css?v=1">' ?>
...
<body>
    ...
    <div id="central">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="form_get_nome" placeholder="Digite o nome da obra" required>
                                </div>
        ...
        <div id="form_obra_search_result_center" class="row justify-content-center align-items-center">
        </div>
    </div>
</body>
