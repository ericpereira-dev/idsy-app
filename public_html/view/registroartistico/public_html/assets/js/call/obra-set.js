...
function obraSend(deleted)
{
    ...
    requestedModel.functionResponse           = obraSendResponse;   
...
var obraSendResponse = function (e_request)
{   
    hideLoader();    
    ...
    else
    {
        ...
        {
            document.getElementById("form_set_id").value = v_result.id_obra;
            if (v_result.qrcode !== "") 
            {
...
{   
    ...
    {           
        ...
        document.getElementById("form_set_nome").value =v_result[0].obra.nome;
